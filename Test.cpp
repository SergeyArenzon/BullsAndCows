...
int main() {
	...
	if (signal == 0) {
		...
		ConstantChooser c1234{"1234"}, c12345{"12345"}, c9999{"9999"},c123{"123"};
		ConstantGuesser g1234{"1234"}, g12345{"12345"}, g9999{"9999"};


		//my tests-->
        ConstantChooser  c2610{"2610"}, c0406{"0406"}, c98765{"98765"},c0123{"0123"},c5555{"5555"};
        ConstantGuesser  g2610{"2610"}, g0406{"0406"}, g98765{"98765"};
		...
		//my tests-->
                ...
                .CHECK_OUTPUT(calculateBullAndPgia("2610","0406"), "0,3")       // 0 bull, 2 pgia
            //<--my test
		...
		//my tests-->
                ...
                .CHECK_EQUAL(play(c0123, g2610, 4, 100), 101)    // guesser loses by running out of turns
        ...
        //my tests-->
        testcase
                .CHECK_EQUAL(play(c5555, smarty, 4, 100) <= 100, true)// smarty should always win in at most 100 turns!
                .CHECK_EQUAL(play(c1234, smarty, 4, 100) <= 100, true)// smarty should always win in at most 100 turns!
                .CHECK_EQUAL(play(c9999, smarty, 4, 100) <= 100, true)// smarty should always win in at most 100 turns!
                .CHECK_EQUAL(play(c0123, smarty, 4, 100) <= 100, true)// smarty should always win in at most 100 turns!
                .CHECK_EQUAL(play(c2610, smarty, 4, 100) <= 100, true)// smarty should always win in at most 100 turns!
                .CHECK_EQUAL(play(c0406, smarty, 4, 100) <= 100, true)// smarty should always win in at most 100 turns!
                .CHECK_EQUAL(play(c0123, smarty, 4, 100) <= 100, true)// smarty should always win in at most 100 turns!
                .CHECK_EQUAL(play(c0123, smarty, 4, 100) <= 100, true)// smarty should always win in at most 100 turns!
                ;
		//<--my tests
